...
local General = EasyFrames:NewModule(MODULE_NAME, "AceConsole-3.0", "AceEvent-3.0", "AceHook-3.0")
local db
...
function General:CheckClassification(frame, forceNormalTexture)
...
function General:HideFramesElements()
...
function General:MoveFramesNames()
    --Names
...
function General:MoveToTFrames()
    --ToT move
...
function General:MovePlayerFrameBars()
    --Player bars
...
function General:MoveTargetFrameBars()
    --Target bars
...
function General:MoveFocusFrameBars()
    --Focus bars
...
function General:MovePetFrameBars()
    --Player Pet bars
...
function General:SetFramesBarsFont()
...
function General:MovePlayerFramesBarsTextString()
...
function General:MoveTargetFramesBarsTextString()
...
function General:MoveFocusFramesBarsTextString()
...
function General:UpdateTextStringWithValues()
