...
L["Show target of focus frame"] = "주시대상의 대상 프레임 보임"
L["Show name of focus frame"] = "주시대상 이름"
L["Show focus combat texture (outside the frame)"] = "주시대상 전투 텍스처 보임"
