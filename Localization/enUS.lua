...
L["Use a third-party addon to get HP (for example, with Real Mob Health)"] = true
L["If using this option, don't forget to install the Real Mob Health addon"] = true
