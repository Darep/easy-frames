...
L["Show player status texture"] = "Показывать статус текстуру игрока"
L["Show or hide the player status texture (blinking glow in the frame when player is resting or in combat)"] = "Показывать статус текстуру игрока (мигающая рамка внутри фрейма во время отдыха или боя)"
